...
My work spans the full ML lifecycle: **predictive analytics**, **NLP solutions**, **computer vision systems**, **RAG pipelines**, and **automated data engineering**. I don't just build models — I build **ML systems that serve live business applications** with verifiable, documented outcomes.
